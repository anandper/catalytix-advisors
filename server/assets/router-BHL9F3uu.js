...
const appCss = "/assets/styles-cc7iCf9b.css";
...
const Route$8 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Catalytix runs the Operator's Audit, a structured on-site assessment for multi-location operators in healthcare, cannabis, hospitality, fuel, and retail."
      },
      { name: "author", content: "Catalytix Advisory" },
      { property: "og:site_name", content: "Catalytix" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Newsreader:ital,opsz,wght@0,6..72,400..600;1,6..72,400..600&display=swap"
      }
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Catalytix",
          description: "Vertical-specialized technology advisory firm. Authorized advisor of Intelisys (a ScanSource company).",
          url: "/"
        })
      }
    ]
...
const verticals = [
  {
    ...
    metaDescription: "Catalytix runs the Operator's Audit for 2–10 location dental groups and DSOs. We find the HIPAA, PMS, and connectivity gaps your IT vendor doesn't.",
    intro: "We work with GP-led dental groups and DSOs running 2 to 10 locations. The patterns are consistent: phone systems acquired one office at a time, a PMS that doesn't speak to the second PMS you inherited, and a HIPAA posture that passes a checklist but wouldn't survive an actual breach review.",
    findings: [
      {
        symptom: "Three offices, three phone systems, three bills",
        detail: "Each location was set up by whoever was selling phones that quarter. Hunt groups don't span sites. After-hours routing is a stack of forwards. Patients drop on hold between offices."
      },
      {
        symptom: "PMS sprawl after acquisition",
        detail: "An office you bought is still on Dentrix while the rest run Open Dental. The connectivity, backup, and HIPAA story is different at every site and nobody owns the consolidation plan."
      },
      {
        symptom: "HIPAA posture that's a checklist, not a posture",
        detail: "You pass the annual risk analysis. You also have a flat network, no segmentation between guest WiFi and the PMS, and admin credentials shared in a Google Doc."
      },
      {
        symptom: "No business continuity if the internet drops",
        detail: "When the circuit goes down, the front desk can't check in patients, can't take payment, and can't pull X-rays. There is no failover. There is a phone tree of IT vendors."
      },
      {
        symptom: "Carrier contracts that auto-renewed in silence",
        detail: "Three of your locations are still paying 2019 rates on a ratified contract that has been auto-extending. Nobody renegotiated when you added sites four and five."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for independent optometry groups and small chains. Stabilize the stack between diagnostic equipment, cloud EHR, and patient communications.",
    intro: "Independent optometry — single-doctor expansions and small chains — sits between a hardware-heavy exam lane and a SaaS-heavy front office. The two halves were almost never designed to live on the same network, and most practices are running a truce, not an architecture.",
    findings: [
      {
        symptom: "Diagnostic devices on the same flat LAN as guest WiFi",
        detail: "The OCT, the visual field, and the patient WiFi share a broadcast domain. One mis-plugged cable and the lane goes down with somebody's Netflix."
      },
      {
        symptom: "Cloud EHR throttled by a residential-grade circuit",
        detail: "You're paying for cloud software on a 100/10 cable line. Image uploads stall during peak hours. Your team blames the EHR vendor. The vendor blames the carrier."
      },
      {
        symptom: "Multi-location patient comms held together by a single person",
        detail: "Recall, reminders, and reviews live in a system that one staff member knows. When she leaves, the workflow leaves with her."
      },
      {
        symptom: "No POTS replacement plan",
        detail: "Your alarm panel and elevator phone still ride on copper. The carrier is sunsetting the line. Nobody has told you and nobody has scoped the swap."
      },
      {
        symptom: "Two phone numbers per location, neither of them the published one",
        detail: "Patients call the listed number. It rolls to a personal cell. The 'main' line goes unanswered. Reviews show it."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for independent multi-location vet groups and small DVM-led chains. Connectivity, PIMS, and continuity built for clinical workflow.",
    intro: "Independent vet groups and small DVM-led chains run heavy clinical files on networks that were never engineered for them. The result is staff working around the system instead of through it.",
    findings: [
      {
        symptom: "Imaging stalls between exam room and server",
        detail: "Digital radiography produces files large enough to choke a residential circuit. Techs wait. Then they retake. Then they wait again."
      },
      {
        symptom: "PIMS dependency with no continuity plan",
        detail: "When the cloud PIMS is unreachable, the practice cannot bill, schedule, or check in. There is no offline mode. There is no second path to the internet."
      },
      {
        symptom: "Phone tree designed for one office, deployed across four",
        detail: "Calls intended for the new location route to the original. Voicemails accumulate at sites that closed last year."
      },
      {
        symptom: "Backups that haven't been tested in 18 months",
        detail: "There is a backup. Nobody has restored from it. The first restore attempt is during an actual outage, which is the wrong time to learn it doesn't work."
      },
      {
        symptom: "Specialty equipment on the carrier's modem",
        detail: "An ultrasound or laser is plugged into the ISP-supplied gateway because nobody scoped a real LAN. The vendor's remote support depends on it."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for independent urgent care and small regional chains. Throughput-grade connectivity, EHR continuity, and HIPAA posture without the theater.",
    intro: "Independent urgent care lives or dies on throughput. The clinical software, the labs interface, the imaging, and the patient registration all ride a network that was usually scoped for an office, not a clinic running 60 patients on a Saturday.",
    findings: [
      {
        symptom: "Single circuit, single point of failure",
        detail: "When the cable line drops, you stop seeing patients. There is no LTE failover. There is no secondary circuit. There is a sign on the door."
      },
      {
        symptom: "EHR latency dressed up as a clinical complaint",
        detail: "Providers are spending eight extra seconds per chart waiting for the EHR to respond. Multiply that across a shift. That's clinic capacity."
      },
      {
        symptom: "Lab and imaging interfaces on the wrong VLAN",
        detail: "Results route slowly because the integration sits on a shared subnet with patient WiFi. The vendor calls it 'normal.' It isn't."
      },
      {
        symptom: "Front desk wait-time visibility nobody has set up",
        detail: "Patients track wait time on your competitor's site. Yours doesn't publish it. The data exists in the EHR."
      },
      {
        symptom: "After-hours coverage routing through a personal cell",
        detail: "On-call providers are reachable through a number that was set up in 2018. When they change, the number doesn't."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for state-legal dispensaries, cultivators, and processors. Track-and-trace, surveillance retention, and segmentation built for compliance.",
    intro: "State-legal cannabis is the most regulated retail environment most operators have ever worked in, and the technology stack rarely reflects it. The Audit looks at the stack the way a compliance officer would, then the way an operator would.",
    findings: [
      {
        symptom: "Surveillance retention that doesn't actually meet the rule",
        detail: "The DVR is configured for the wrong frame rate, the wrong retention, or both. Pulling a clip on demand is a 40-minute exercise."
      },
      {
        symptom: "POS, track-and-trace, and guest WiFi on one flat network",
        detail: "There is no segmentation between the patient/customer-facing wireless and the systems regulators care about. One compromised guest device puts the license at risk."
      },
      {
        symptom: "Connectivity that goes down at the wrong time",
        detail: "When the circuit drops, METRC / BioTrack / state portal sync stops. Sales continue offline. Reconciliation becomes Monday's problem."
      },
      {
        symptom: "Compliance stitched together by one person",
        detail: "Reports run because someone built a workflow in their head. They take a vacation; the workflow does too."
      },
      {
        symptom: "Cultivation ops on a network that wasn't scoped for them",
        detail: "Environmental controls, fertigation, and security cameras share bandwidth with the office. Latency spikes have operational consequences."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for independent hotels, restaurant groups, and franchisees. Guest WiFi, PMS, POS, and continuity that won't blow up Friday at 7pm.",
    intro: "Independent hotels, restaurant groups, and franchisees run customer-facing technology on infrastructure that was designed for a back office. The brand experience your guest remembers — the WiFi that worked, the check-in that didn't take 15 minutes, the POS that didn't crash — depends on a stack nobody is sitting on top of.",
    findings: [
      {
        symptom: "Guest WiFi that meets the brand standard on paper, not in the room",
        detail: "Coverage maps from the install are five years old. Half the rooms get a usable signal. The other half don't, and you're paying for the same circuit either way."
      },
      {
        symptom: "PMS / POS continuity nobody has tested",
        detail: "When the internet drops on a Friday at 7pm, the POS goes into offline mode that nobody has trained the staff to operate."
      },
      {
        symptom: "POTS lines holding up the building",
        detail: "Elevator phones, fire panel, alarm. All on copper. All on a sunset path. Nobody has scoped the replacement."
      },
      {
        symptom: "Multi-property phone systems that don't talk to each other",
        detail: "The reservation desk at one property can't transfer to another. Group inquiries die between sites."
      },
      {
        symptom: "Surveillance retention shorter than your liability window",
        detail: "If an incident happens 31 days ago, you don't have footage. Insurance is going to ask."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for multi-location independent c-store operators. Stabilize POS, payments, lottery, surveillance, and back-office under one architecture.",
    intro: "Independent c-store operators — often paired with fuel — run more concurrent systems per square foot than almost any other retail format. The Audit looks at every one of them, on every site, and identifies the ones that share a single point of failure.",
    findings: [
      {
        symptom: "Every system shares one circuit",
        detail: "POS, payment processing, lottery, age verification, ATM, surveillance, back-office. When the line drops, the store stops."
      },
      {
        symptom: "No PCI segmentation — and no plan to get it",
        detail: "Cardholder data, employee WiFi, and surveillance share the same VLAN. Scope is the entire store. It doesn't have to be."
      },
      {
        symptom: "Surveillance retention that won't satisfy a claim",
        detail: "DVRs configured at install. Never re-checked. Retention shorter than the incident window your insurer asks about."
      },
      {
        symptom: "Site-to-site visibility nobody has",
        detail: "You don't know in real time which stores are up. You find out when the manager calls."
      },
      {
        symptom: "POTS lines you forgot you were paying for",
        detail: "Copper lines for ATMs and alarms that haven't been used in years still on the bill. Cancelling them is its own project."
      }
    ],
    faq: [
      {
  ...
  },
  {
    ...
    metaDescription: "The Operator's Audit for California-focused multi-site gas station operators. Pumps, EMV, tank monitoring, surveillance, and POTS replacement under one architecture.",
    intro: "California-focused, multi-site, jobber-supplied operators are the most demanding c-store/fuel hybrid in the country. CARB, EMV, ADA, and the brand fuel agreement all converge on a network that the carrier rep has never set foot inside. The Audit is for ten or more sites; below that the dynamics aren't there yet.",
    findings: [
      {
        symptom: "POTS replacement nobody has scoped",
        detail: "Tank monitoring, alarm, and elevator phones still on copper. The carrier is moving off it. The cost to do nothing goes up every year."
      },
      {
        symptom: "EMV liability sitting on hardware that's a generation behind",
        detail: "Pumps that were grandfathered in are now exposed. The chargeback math has changed."
      },
      {
        symptom: "Surveillance retention shorter than the brand requires",
        detail: "DVRs were installed at the original spec. The brand spec changed. Nobody updated the sites."
      },
      {
        symptom: "Stranded carrier spend across the footprint",
        detail: "When you added stations seven through ten, you signed a contract per site. Nobody renegotiated the original three."
      },
      {
        symptom: "Back-office visibility you don't actually have",
        detail: "You can't see in real time which sites are taking cards, which are down, and which have a tank reading the manager hasn't acknowledged."
      }
    ],
    faq: [
      {
...
const verticalBySlug = (slug) => verticals.find((v) => v.slug === slug);
const BASE_URL = "";
    ...
    handlers: {
      GET: async () => {
        const paths = [
          ...
          "/contact",
          "/insights",
          ...verticals.map((v) => `/verticals/${v.slug}`)
        ];
...
const $$splitComponentImporter$6 = () => import("./insights-BhhUpO0p.js");
const Route$6 = createFileRoute("/insights")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Plainspoken field notes for multi-location operators in healthcare, cannabis, hospitality, fuel, and retail."
    }, {
      property: "og:title",
      content: "Catalytix Insights"
    }, {
      property: "og:url",
      content: "/insights"
    }],
...
const $$splitComponentImporter$5 = () => import("./contact-CHZnMrXK.js");
const Route$5 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tell us your operation. We'll get back within one business day to scope the Audit."
    }, {
      property: "og:title",
      content: "Schedule the Operator's Audit"
    }, {
      property: "og:url",
      content: "/contact"
    }],
...
function FaqList({ items }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { className: "divide-y divide-rule border-y border-rule", children: items.map((i, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-8 lg:grid-cols-[1fr_2fr] lg:gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "font-serif text-xl text-ink", children: i.q }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-ink/70 text-pretty leading-relaxed", children: i.a })
  ] }, idx)) });
}
const $$splitComponentImporter$4 = () => import("./audit-DoYv0X5x.js");
const Route$4 = createFileRoute("/audit")({
  head: () => ({
    meta: [{
      title: "Services — Catalytix"
    }, {
      name: "description",
      content: "Technology advisory and procurement across UCaaS, CCaaS, SD-WAN, SASE, cybersecurity, cloud, and connectivity. Powered by 200+ vetted Intelisys suppliers."
    }, {
      property: "og:title",
      content: "Services — Catalytix"
    }],
    links: [{
      rel: "canonical",
      href: "/audit"
    ...
    scripts: [{
      type: "application/ld+json",
      children: JSON.stringify(faqJsonLd(auditFaq))
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./about-DwWmFLmC.js");
const Route$3 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Catalytix is a vertical-specialized technology advisory firm and authorized advisor of Intelisys, a ScanSource company. Built for operators, by operators."
    }, {
      property: "og:title",
      content: "About Catalytix"
    }, {
...
const $$splitComponentImporter$2 = () => import("./index-CpNJSMGK.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Catalytix is an independent technology advisory firm. We help multi-location businesses design, source, and run modern IT — from UCaaS and SD-WAN to cybersecurity and cloud."
    }, {
      property: "og:title",
      content: "Catalytix — Technology advisory for modern operators"
    }, {
      property: "og:description",
      content: "Independent technology advisory powered by Intelisys. Vendor-neutral guidance across 200+ vetted suppliers."
    }],
    links: [{
      rel: "canonical",
      href: "/"
...
const $$splitComponentImporter$1 = () => import("./verticals.gas-stations-oBOk7lTf.js");
const metaTitle = "Technology advisor for California gas station operators | Catalytix";
const metaDescription = "Catalytix Advisors designs the technology stack for multi-site California gas station operators — POTS replacement, EMV, PCI segmentation, ATG telemetry, surveillance, and CARB ISD connectivity.";
const Route$1 = createFileRoute("/verticals/gas-stations")({
  head: () => ({
    meta: [{
      title: metaTitle
    }, {
      ...
      property: "og:url",
      content: "/verticals/gas-stations"
    }, {
      property: "og:type",
      content: "article"
    }],
...
const $$splitComponentImporter = () => import("./verticals._slug-Cf0UNKZn.js");
const $$splitNotFoundComponentImporter = () => import("./verticals._slug-Cdc4Ta7X.js");
const Route2 = createFileRoute("/verticals/$slug")({
  loader: ({
    params
  }) => {
  ...
  head: ({
    ...
    if (!loaderData) return {
      meta: [{
        title: "Vertical not found | Catalytix"
      }]
    };
    return {
      meta: [{
        ...
        property: "og:title",
        content: loaderData.metaTitle
      }, {
        property: "og:description",
        content: loaderData.metaDescription
      }, {
        property: "og:url",
        content: `/verticals/${params.slug}`
      }, {
        property: "og:type",
        content: "article"
      }],
...
const AuditRoute = Route$4.update({
  id: "/audit",
  path: "/audit",
  getParentRoute: () => Route$8
});
...
const VerticalsGasStationsRoute = Route$1.update({
  id: "/verticals/gas-stations",
  path: "/verticals/gas-stations",
  getParentRoute: () => Route$8
});
const VerticalsSlugRoute = Route2.update({
  id: "/verticals/$slug",
  path: "/verticals/$slug",
  getParentRoute: () => Route$8
});
